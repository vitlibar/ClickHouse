...
{
public:
    ContextAccessCache(const AccessControlManager & manager_) : manager(manager_) {}
...
{
    return quota_cache->getEnabledQuota(user_name, user_id, enabled_roles, address, custom_quota_key);
}
