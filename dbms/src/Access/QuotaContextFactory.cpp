...
std::shared_ptr<QuotaContext> QuotaContextFactory::createContext(const UUID & user_id, const String & user_name, const Poco::Net::IPAddress & address, const String & client_key)
{
