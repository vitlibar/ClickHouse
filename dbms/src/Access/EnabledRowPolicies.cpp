...
bool operator ==(const EnabledRowPolicies::Params & lhs, const EnabledRowPolicies::Params & rhs)
{
    return (lhs.user_id == rhs.user_id) && (lhs.enabled_roles == rhs.enabled_roles);
}
...
bool operator <(const EnabledRowPolicies::Params & lhs, const EnabledRowPolicies::Params & rhs)
{
    ...
    if (lhs.user_id > rhs.user_id)
        return false;
    return lhs.enabled_roles < rhs.enabled_roles;
}
