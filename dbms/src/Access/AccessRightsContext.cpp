...
bool AccessRightsContext::isGranted(Poco::Logger * log_, const AccessFlags & access, CurrentDatabaseTag) const { return checkImpl<LOG_WARNING_IF_ACCESS_DENIED>(log_, access, current_database); }
bool AccessRightsContext::isGranted(Poco::Logger * log_, const AccessFlags & access, CurrentDatabaseTag, const std::string_view & table) const { return checkImpl<LOG_WARNING_IF_ACCESS_DENIED>(log_, access, current_database, table); }
bool AccessRightsContext::isGranted(Poco::Logger * log_, const AccessFlags & access, CurrentDatabaseTag, const std::string_view & table, const std::string_view & column) const { return checkImpl<LOG_WARNING_IF_ACCESS_DENIED>(log_, access, current_database, table, column); }
bool AccessRightsContext::isGranted(Poco::Logger * log_, const AccessFlags & access, CurrentDatabaseTag, const std::string_view & table, const std::vector<std::string_view> & columns) const { return checkImpl<LOG_WARNING_IF_ACCESS_DENIED>(log_, access, current_database, table, columns); }
bool AccessRightsContext::isGranted(Poco::Logger * log_, const AccessFlags & access, CurrentDatabaseTag, const std::string_view & table, const Strings & columns) const { return checkImpl<LOG_WARNING_IF_ACCESS_DENIED>(log_, access, current_database, table, columns); }
