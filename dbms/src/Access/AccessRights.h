...
public:
    ...
    AccessFlags getAccess() const;
    AccessFlags getAccess(const std::string_view & database) const;
    AccessFlags getAccess(const std::string_view & database, const std::string_view & table) const;
    AccessFlags getAccess(const std::string_view & database, const std::string_view & table, const std::string_view & column) const;
    AccessFlags getAccess(const std::string_view & database, const std::string_view & table, const std::vector<std::string_view> & columns) const;
    AccessFlags getAccess(const std::string_view & database, const std::string_view & table, const Strings & columns) const;
