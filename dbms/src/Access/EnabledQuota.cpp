...
bool operator ==(const EnabledQuota::Params & lhs, const EnabledQuota::Params & rhs)
{
    return (lhs.user_id == rhs.user_id) && (lhs.enabled_roles == rhs.enabled_roles) && (lhs.user_name == rhs.user_name)
        && (lhs.client_address == rhs.client_address) && (lhs.client_key == rhs.client_key);
}
...
bool operator <(const EnabledQuota::Params & lhs, const EnabledQuota::Params & rhs)
{
    ...
    if (lhs.user_id > rhs.user_id)
        return false;
    if (lhs.enabled_roles < rhs.enabled_roles)
        return true;
    if (lhs.enabled_roles > rhs.enabled_roles)
        return false;
    ...
    if (lhs.user_name > rhs.user_name)
        return false;
    if (lhs.client_address < rhs.client_address)
        return true;
    if (lhs.client_address > rhs.client_address)
        return false;
    return (lhs.client_key < rhs.client_key);
}
