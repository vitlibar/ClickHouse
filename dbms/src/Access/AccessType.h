...
#define ACCESS_TYPE_TO_KEYWORD_CASE(type) \
            ...
            ACCESS_TYPE_TO_KEYWORD_CASE(ATTACH_PARTITION);
            ACCESS_TYPE_TO_KEYWORD_CASE(DETACH_PARTITION);
            ACCESS_TYPE_TO_KEYWORD_CASE(DROP_PARTITION);
            ACCESS_TYPE_TO_KEYWORD_CASE(COPY_PARTITION);
            ACCESS_TYPE_TO_KEYWORD_CASE(MOVE_PARTITION_TO_DISK);
            ACCESS_TYPE_TO_KEYWORD_CASE(MOVE_PARTITION_TO_VOLUME);
            ACCESS_TYPE_TO_KEYWORD_CASE(FETCH_PARTITION);
            ACCESS_TYPE_TO_KEYWORD_CASE(FREEZE_PARTITION);
            ACCESS_TYPE_TO_KEYWORD_CASE(PARTITION);

            ACCESS_TYPE_TO_KEYWORD_CASE(ALTER_TABLE);

            ACCESS_TYPE_TO_KEYWORD_CASE(REFRESH_LIVE_VIEW);
