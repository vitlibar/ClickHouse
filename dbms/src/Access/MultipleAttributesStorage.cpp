...
MultipleAttributesStorage::MultipleAttributesStorage(
    const String & storage_name_, std::vector<std::unique_ptr<Storage>> nested_storages_, size_t index_of_nested_storage_for_insertion_)
    ...
    , names_and_types_cache(CACHE_MAX_SIZE)
    , ids_cache(CACHE_MAX_SIZE)
{
}
