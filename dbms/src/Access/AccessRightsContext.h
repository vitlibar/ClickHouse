...
public:
    ...
    bool isGranted(Poco::Logger * log_, const AccessFlags & access, CurrentDatabaseTag) const;
    bool isGranted(Poco::Logger * log_, const AccessFlags & access, CurrentDatabaseTag, const std::string_view & table) const;
    bool isGranted(Poco::Logger * log_, const AccessFlags & access, CurrentDatabaseTag, const std::string_view & table, const std::string_view & column) const;
    bool isGranted(Poco::Logger * log_, const AccessFlags & access, CurrentDatabaseTag, const std::string_view & table, const std::vector<std::string_view> & columns) const;
    bool isGranted(Poco::Logger * log_, const AccessFlags & access, CurrentDatabaseTag, const std::string_view & table, const Strings & columns) const;
