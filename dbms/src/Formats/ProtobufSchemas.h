...
public:
    ...
    const google::protobuf::Message* readPrototypeFromProtoFile(const String & proto_file_path, const String & message_name);
...
private:
    ...
    std::map<String, const google::protobuf::Message*> format_schema_to_prototype_map;
};
