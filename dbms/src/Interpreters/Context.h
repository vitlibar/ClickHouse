...
private:
    ...
    std::shared_ptr<QuotaUsageContext> quota;           /// Current quota. By default - empty quota, that have no limits.
...
public:
    ...
    std::shared_ptr<QuotaUsageContext> getQuota() const { return quota; }
