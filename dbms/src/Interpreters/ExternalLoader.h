...
public:
    ...
    void addConfigRepository(IExternalLoaderConfigRepository * config_repository);
    /// Removes a repository which were used to read configurations.
    void removeConfigRepository(IExternalLoaderConfigRepository * config_repository);
