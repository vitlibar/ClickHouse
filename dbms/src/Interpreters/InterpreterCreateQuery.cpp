...
AccessRightsElements InterpreterCreateQuery::getRequiredAccess() const
{
    ...
    else if (create.is_dictionary)
    {
        ...
        required_access.back().replaceDatabase("", AccessRightsElement::CurrentDatabaseTag{});
    }
    ...
    {
        required_access.emplace_back(AccessType::INSERT, create.to_database, create.to_table);  /// TODO: columns?
        required_access.back().replaceDatabase("", AccessRightsElement::CurrentDatabaseTag{});
    }
