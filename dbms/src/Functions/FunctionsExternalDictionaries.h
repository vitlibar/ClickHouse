...
private:
    ...
    void executeImpl(Block & block, const ColumnNumbers & arguments, size_t result, size_t input_rows_count) override
    {
        ...
        context.checkAccess(AccessType::dictHas, dict_ptr->getDatabase(), dict_ptr->getName());
...
private:
    ...
    void executeImpl(Block & block, const ColumnNumbers & arguments, size_t result, size_t input_rows_count) override
    {
        ...
        auto dict = dictionaries_loader.getDictionary(dict_name_col->getValue<String>());
        const auto dict_ptr = dict.get();
        context.checkAccess(AccessType::dictGet, dict_ptr->getDatabase(), dict_ptr->getName());
...
private:
    ...
    void executeImpl(Block & block, const ColumnNumbers & arguments, size_t result, size_t input_rows_count) override
    {
        ...
        auto dict = dictionaries_loader.getDictionary(dict_name_col->getValue<String>());
        const auto dict_ptr = dict.get();
        context.checkAccess(AccessType::dictGetHierarchy, dict_ptr->getDatabase(), dict_ptr->getName());
...
private:
    ...
    void executeImpl(Block & block, const ColumnNumbers & arguments, size_t result, size_t input_rows_count) override
    {
        ...
        auto dict = dictionaries_loader.getDictionary(dict_name_col->getValue<String>());
        const auto dict_ptr = dict.get();
        context.checkAccess(AccessType::dictIsIn, dict_ptr->getDatabase(), dict_ptr->getName());
