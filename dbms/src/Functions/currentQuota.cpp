...
public:
    ...
    {
        return std::make_shared<FunctionCurrentQuota>(context.getQuota()->getInfo().quota_name);
    }
...
public:
    ...
    static FunctionPtr create(const Context & context)
    {
        return std::make_shared<FunctionCurrentQuotaId>(context.getQuota()->getInfo().quota_id);
    }
...
public:
    ...
    static FunctionPtr create(const Context & context)
    {
        return std::make_shared<FunctionCurrentQuotaKey>(context.getQuota()->getInfo().quota_key);
    }
