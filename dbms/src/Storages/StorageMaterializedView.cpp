    ...
    const String & /*new_path_to_db*/, const String & new_database_name, const String & new_table_name, TableStructureWriteLockHolder &)
{
    ...
    view_dependencies.add({select_database_name, select_table_name}, {database_name, table_name});
}
...
void StorageMaterializedView::shutdown()
{
    ...
    global_context.getViewDependencies().remove({select_database_name, select_table_name}, {database_name, table_name});
}
