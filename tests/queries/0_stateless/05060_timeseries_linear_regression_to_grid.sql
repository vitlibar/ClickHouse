...
-- second. The PromQL function `predict_linear` with a per-step horizon is built on it, see 04551_promql_phase3_range_functions
-- and 04700_promql_predict_linear_non_literal_scalar.
...
SELECT toTypeName(timeSeriesLinearRegressionToGrid(100, 120, 10, 30)(timestamps, values));
WITH [100, 110, 120]::Array(DateTime) AS timestamps, [10, 20, 30]::Array(Float64) AS values
...
SELECT timeSeriesLinearRegressionToGrid(100, 120, 10, 30)(timestamps, values) AS regression, toTypeName(regression);
