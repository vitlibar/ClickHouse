...
-- The thresholds set by the user are respected. Both thresholds are raised here: the greater of the two applies,
-- and the selector lowers both of them by default (a row of the samples table holds many samples).
