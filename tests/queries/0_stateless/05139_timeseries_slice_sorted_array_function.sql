...
SELECT timeSeriesSliceSortedArray(timeSeriesGroupArray(samples), '2025-06-01 00:00:30'::DateTime64(3), '2025-06-01 00:01:00'::DateTime64(3)) AS result FROM slice_test GROUP BY id;
