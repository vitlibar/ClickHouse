...
def test_restore_from_version_1():
    ...
    # TODO: Get rid of SETTINGS allow_different_table_def=1
    node.query("RESTORE TABLE default.prometheus FROM Disk('backups', 'time_series_version_1.zip') SETTINGS allow_different_table_def=1")
    send_bar_via_remote_write()
    check_foo_and_bar()
