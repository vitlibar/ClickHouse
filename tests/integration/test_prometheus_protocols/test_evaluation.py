...
def test_math_functions():
    ...
    do_query_test(
        ...
        [["[('job','test')]", "[('1970-01-01 00:01:40.000',2),('1970-01-01 00:03:20.000',1),('1970-01-01 00:05:00.000',0.5),('1970-01-01 00:06:40.000',0),('1970-01-01 00:08:20.000',0.5),('1970-01-01 00:10:00.000',1),('1970-01-01 00:11:40.000',2)]"]]
    )
    ...
    do_query_test(
        ...
        [["[('job','test')]", "[('1970-01-01 00:01:40.000',-1),('1970-01-01 00:03:20.000',-1),('1970-01-01 00:05:00.000',-1),('1970-01-01 00:06:40.000',0),('1970-01-01 00:08:20.000',1),('1970-01-01 00:10:00.000',1),('1970-01-01 00:11:40.000',1)]"]]
    )
    ...
    do_query_test(
        ...
        [["[('job','test')]", "[('1970-01-01 00:01:40.000',-2),('1970-01-01 00:03:20.000',-1),('1970-01-01 00:05:00.000',-1),('1970-01-01 00:06:40.000',0),('1970-01-01 00:08:20.000',0),('1970-01-01 00:10:00.000',1),('1970-01-01 00:11:40.000',2)]"]]
    )
    ...
    do_query_test(
        ...
        [["[('job','test')]", "[('1970-01-01 00:01:40.000',-2),('1970-01-01 00:03:20.000',-1),('1970-01-01 00:05:00.000',-0),('1970-01-01 00:06:40.000',0),('1970-01-01 00:08:20.000',1),('1970-01-01 00:10:00.000',1),('1970-01-01 00:11:40.000',2)]"]]
    )
    ...
    do_query_test(
        ...
        [["[('job','test')]", "[('1970-01-01 00:01:40.000',nan),('1970-01-01 00:03:20.000',nan),('1970-01-01 00:05:00.000',nan),('1970-01-01 00:06:40.000',0),('1970-01-01 00:08:20.000',0.7071067811865476),('1970-01-01 00:10:00.000',1),('1970-01-01 00:11:40.000',1.4142135623730951)]"]]
    )
    ...
    do_query_test(
        ...
        [["[('job','test')]", "[('1970-01-01 00:01:40.000',nan),('1970-01-01 00:03:20.000',nan),('1970-01-01 00:05:00.000',nan),('1970-01-01 00:06:40.000',-inf),('1970-01-01 00:08:20.000',-0.6931471805599453),('1970-01-01 00:10:00.000',0),('1970-01-01 00:11:40.000',0.6931471805599453)]"]]
    )
    ...
    do_query_test(
        ...
        [["[('job','test')]", "[('1970-01-01 00:01:40.000',nan),('1970-01-01 00:03:20.000',nan),('1970-01-01 00:05:00.000',nan),('1970-01-01 00:06:40.000',-inf),('1970-01-01 00:08:20.000',-1),('1970-01-01 00:10:00.000',0),('1970-01-01 00:11:40.000',1)]"]]
    )
    ...
    do_query_test(
        ...
        [["[('job','test')]", "[('1970-01-01 00:01:40.000',nan),('1970-01-01 00:03:20.000',nan),('1970-01-01 00:05:00.000',nan),('1970-01-01 00:06:40.000',-inf),('1970-01-01 00:08:20.000',-0.3010299956639812),('1970-01-01 00:10:00.000',0),('1970-01-01 00:11:40.000',0.3010299956639812)]"]]
    )
    ...
    do_query_test(
        ...
        [["[('job','test')]", "[('1970-01-01 00:01:40.000',-0.03490658503988659),('1970-01-01 00:03:20.000',-0.017453292519943295),('1970-01-01 00:05:00.000',-0.008726646259971648),('1970-01-01 00:06:40.000',0),('1970-01-01 00:08:20.000',0.008726646259971648),('1970-01-01 00:10:00.000',0.017453292519943295),('1970-01-01 00:11:40.000',0.03490658503988659)]"]]
    )
    ...
    do_query_test(
        ...
        [["[('job','test')]", "[('1970-01-01 00:01:40.000',-114.59155902616465),('1970-01-01 00:03:20.000',-57.29577951308232),('1970-01-01 00:05:00.000',-28.64788975654116),('1970-01-01 00:06:40.000',0),('1970-01-01 00:08:20.000',28.64788975654116),('1970-01-01 00:10:00.000',57.29577951308232),('1970-01-01 00:11:40.000',114.59155902616465)]"]]
    )
    ...
    do_query_test(
        ...
        # | E     - {"resultType": "vector", "result": [{"metric": {"job": "test"}, "value": [600, "0.7615941559557649"]}]}
        # | E     ?                                                                                          -- ^^^^ ^
        # | E     + {"resultType": "vector", "result": [{"metric": {"job": "test"}, "value": [600, "0.7615946626193841"]}]}
        # | E     ?                                                                                         ++++  ^^ ^
        # The function tanh() in ClickHouse isn't very precise: "SELECT tanh(1)" returns 0.7615946626193841,
        # however the correct value is 0.7615941559557649
        False
    )
...
def test_date_time_functions():
    ...
    do_query_test(
        ...
        [["[('job','test')]", "[('1970-01-01 00:01:50.000',0),('1970-01-01 00:02:00.000',6)]"]]
    )
    ...
    do_query_test(
        ...
        [["[('job','test')]", "[('1970-01-01 00:01:50.000',30),('1970-01-01 00:02:00.000',6)]"]]
    )
    ...
    do_query_test(
        ...
        [["[('job','test')]", "[('1970-01-01 00:01:50.000',334),('1970-01-01 00:02:00.000',340)]"]]
    )
    ...
    do_query_test(
        ...
        [["[('job','test')]", "[('1970-01-01 00:01:50.000',30),('1970-01-01 00:02:00.000',30)]"]]
    )
    ...
    do_query_test(
        ...
        [["[('job','test')]", "[('1970-01-01 00:01:50.000',10),('1970-01-01 00:02:00.000',15)]"]]
    )
    ...
    do_query_test(
        ...
        [["[('job','test')]", "[('1970-01-01 00:01:50.000',11),('1970-01-01 00:02:00.000',12)]"]]
    )
    ...
    do_query_test(
        ...
        [["[('job','test')]", "[('1970-01-01 00:01:50.000',2025),('1970-01-01 00:02:00.000',2025)]"]]
    )
...
def test_alignment_with_subquery_step():
    do_query_test(
        "vector(1)[100:20]",
        100000,
        '{"resultType": "matrix", "result": [{"metric": {}, "values": [[99920, "1"], [99940, "1"], [99960, "1"], [99980, "1"], [100000, "1"]]}]}',
        [["[]", "[('1970-01-02 03:45:20.000',1),('1970-01-02 03:45:40.000',1),('1970-01-02 03:46:00.000',1),('1970-01-02 03:46:20.000',1),('1970-01-02 03:46:40.000',1)]"]]
    )

    do_query_test(
        "vector(1)[100:20]",
        99999,
        '{"resultType": "matrix", "result": [{"metric": {}, "values": [[99900, "1"], [99920, "1"], [99940, "1"], [99960, "1"], [99980, "1"]]}]}',
        [["[]", "[('1970-01-02 03:45:00.000',1),('1970-01-02 03:45:20.000',1),('1970-01-02 03:45:40.000',1),('1970-01-02 03:46:00.000',1),('1970-01-02 03:46:20.000',1)]"]]
    )
    ...
    do_query_test(
        "vector(1)[100:20]",
        99979,
        '{"resultType": "matrix", "result": [{"metric": {}, "values": [[99880, "1"], [99900, "1"], [99920, "1"], [99940, "1"], [99960, "1"]]}]}',
        [["[]", "[('1970-01-02 03:44:40.000',1),('1970-01-02 03:45:00.000',1),('1970-01-02 03:45:20.000',1),('1970-01-02 03:45:40.000',1),('1970-01-02 03:46:00.000',1)]"]]
    )

    do_query_test(
        "vector(1)[20:20]",
        99999,
        '{"resultType": "matrix", "result": [{"metric": {}, "values": [[99980, "1"]]}]}',
        [["[]", "[('1970-01-02 03:46:20.000',1)]"]]
    )

    do_query_test(
        "vector(1)[1:20]",
        99999,
        '{"resultType": "matrix", "result": [{"metric": {}, "values": [[100000, "1"]]}]}',
        [["[]", "[('1970-01-02 03:46:40.000',1)]"]]
    )
