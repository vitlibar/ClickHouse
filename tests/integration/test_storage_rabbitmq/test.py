...
def test_rabbitmq_json_without_delimiter_3(rabbitmq_cluster):
    instance.query('''
        CREATE TABLE test.rabbitmq (key UInt64, value UInt64)
            ENGINE = RabbitMQ
            SETTINGS rabbitmq_host_port = '{}:5672',
                     rabbitmq_exchange_name = 'json3',
                     rabbitmq_format = 'JSONEachRow'
        '''.format(rabbitmq_cluster.rabbitmq_host))
    ...
    all_messages = [messages]
    for message in all_messages:
        channel.basic_publish(exchange='json3', routing_key='', body=message)
...
def test_rabbitmq_json_without_delimiter_4(rabbitmq_cluster):
    instance.query('''
        CREATE TABLE test.rabbitmq (key UInt64, value UInt64)
            ENGINE = RabbitMQ
            SETTINGS rabbitmq_host_port = 'rabbitmq1:5672',
                     rabbitmq_exchange_name = 'json4',
                     rabbitmq_format = 'JSONEachRow'
        ''')
    ...
    all_messages = [messages]
    for message in all_messages:
        channel.basic_publish(exchange='json4', routing_key='', body=message)
...
def test_rabbitmq_json_without_delimiter_5(rabbitmq_cluster):
    instance.query('''
        CREATE TABLE test.rabbitmq (key UInt64, value UInt64)
            ENGINE = RabbitMQ
            SETTINGS rabbitmq_host_port = 'rabbitmq1:5672',
                     rabbitmq_exchange_name = 'json5',
                     rabbitmq_format = 'JSONEachRow'
        ''')
    ...
    all_messages = [messages]
    for message in all_messages:
        channel.basic_publish(exchange='json5', routing_key='', body=message)
...
def test_rabbitmq_json_without_delimiter_6(rabbitmq_cluster):
    instance.query('''
        CREATE TABLE test.rabbitmq (key UInt64, value UInt64)
            ENGINE = RabbitMQ
            SETTINGS rabbitmq_host_port = 'rabbitmq1:5672',
                     rabbitmq_exchange_name = 'json6',
                     rabbitmq_format = 'JSONEachRow'
        ''')
    ...
    channel.basic_publish(exchange='json6', routing_key='', body=message)
