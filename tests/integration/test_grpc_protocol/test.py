...
def test_result_compression():
    query_info = clickhouse_grpc_pb2.QueryInfo(query="SELECT 0 FROM numbers(1000000)",
                                               result_compression=clickhouse_grpc_pb2.Compression(algorithm=clickhouse_grpc_pb2.CompressionAlgorithm.COMPRESSION_GZIP,
                                                                                                  level=clickhouse_grpc_pb2.CompressionLevel.COMPRESSION_LEVEL_HIGH))
    stub = clickhouse_grpc_pb2_grpc.ClickHouseStub(main_channel)
