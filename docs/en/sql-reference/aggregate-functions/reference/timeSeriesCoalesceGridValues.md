...
:::note
This function is experimental. Enable it by setting `allow_experimental_time_series_aggregate_functions = 1` (and `allow_experimental_time_series_table = 1` if you use it with experimental time series tables).
:::
