...
ContextPtr readSettingsFromDictionaryConfigIntoContextCopy(const Poco::Util::AbstractConfiguration & config, const std::string & config_prefix, ContextPtr context);
