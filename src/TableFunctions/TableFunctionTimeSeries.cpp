...
template <TargetKind target_kind>
...
{
    factory.registerFunction<TableFunctionTimeSeriesTarget<TargetKind::Data>>();
    factory.registerFunction<TableFunctionTimeSeriesTarget<TargetKind::Tags>>();
    factory.registerFunction<TableFunctionTimeSeriesTarget<TargetKind::Metrics>>();
}
