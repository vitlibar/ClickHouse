...
public:
    ...
    const ViewTarget & getTarget(ViewTarget::Kind kind = ViewTarget::Kind::Default) const;
    const StorageID & getTargetTableID(ViewTarget::Kind kind = ViewTarget::Kind::Default) const;
    bool hasTargetTableID(ViewTarget::Kind kind = ViewTarget::Kind::Default) const;
    const UUID & getTargetInnerUUID(ViewTarget::Kind kind = ViewTarget::Kind::Default) const;
