...
const ViewTarget & ViewTarget::getEmpty(TargetKind kind_)
{
    switch (kind_)
    {
        /// `s_empty` is a different variable for each Kind.
        case TargetKind::Default: { static const ViewTarget s_empty{kind_}; return s_empty; }
        case TargetKind::Inner:   { static const ViewTarget s_empty{kind_}; return s_empty; }
        case TargetKind::Data:    { static const ViewTarget s_empty{kind_}; return s_empty; }
        case TargetKind::Tags:    { static const ViewTarget s_empty{kind_}; return s_empty; }
        case TargetKind::Metrics: { static const ViewTarget s_empty{kind_}; return s_empty; }
    }
...
const ViewTarget & ASTViewTargets::getTarget(TargetKind kind) const
{
