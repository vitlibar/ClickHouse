...
struct CreateQueryUUIDs
{
    ...
    void setTargetInnerUUID(const UUID & new_inner_uuid) { setTargetInnerUUID(ViewTarget::Kind::Target, new_inner_uuid); }
    UUID getTargetInnerUUID(ViewTarget::Kind kind = ViewTarget::Kind::Target) const;
