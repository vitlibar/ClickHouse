...
struct SettingFieldTimespan
{
    ...
    template <class Rep, class Period = std::ratio<1>>
    SettingFieldTimespan & operator =(const std::chrono::duration<Rep, Period> & x) { return *this = Poco::Timespan{static_cast<Poco::Timespan::TimeDiff>(std::chrono::duration_cast<std::chrono::microseconds>(x).count())}; }

    SettingFieldTimespan & operator =(UInt64 x) { return *this = Poco::Timespan{static_cast<Poco::Timespan::TimeDiff>(x * microseconds_per_unit)}; }
...
struct SettingFieldString
{
    ...
    SettingFieldString & operator =(const String & str) { return *this = std::string_view{str}; }
    SettingFieldString & operator =(String && str) { value = std::move(str); changed = true; return *this; }
    SettingFieldString & operator =(const char * str) { return *this = std::string_view{str}; }
    SettingFieldString & operator =(const Field & f) { return *this = f.safeGet<const String &>(); }
...
struct SettingFieldURI
{
    ...
    SettingFieldURI & operator =(const String & str) { return *this = Poco::URI{str}; }
    SettingFieldURI & operator =(const char * str) { return *this = Poco::URI{str}; }
    SettingFieldURI & operator =(const Field & f) { return *this = f.safeGet<const String &>(); }
...
struct SettingFieldEnum
{
    ...
    SettingFieldEnum & operator =(const Field & f) { return *this = Traits::fromString(f.safeGet<const String &>()); }
