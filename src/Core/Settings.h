...
#define COMMON_SETTINGS(M) \
    ...
    M(UInt64, multiple_joins_rewriter_version, 1, "1 or 2. Second rewriter version knows about table columns and keep not clashed names as is.", 0) \
...
struct Settings : public BaseSettings<SettingsTraits>
{
    ...
    void dumpToArrayColumns(IColumn * column_names, IColumn * column_values, bool with_unchanged = false);
