...
If this setting is enabled, the query with GROUP BY will be processed in a streaming fashion: aggregation will be performed, finalized and flushed for every block of data.
)", 0) \
    \
