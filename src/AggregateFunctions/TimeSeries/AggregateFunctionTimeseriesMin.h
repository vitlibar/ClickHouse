...
struct AggregateFunctionTimeseriesMinTraits
{
    ...
    using ResultValueType = std::conditional_t<return_timestamp, Float64, ValueType>;
    ...
    struct Aggregator
    {
        ...
        std::optional<ResultValueType> getResult(TimestampType /*grid_timestamp*/) const
        {
    ...
    /// Two-stacks vs recompute thresholds, see `AggregateFunctionTimeseriesLinearRegression.h`.
