...
public:
    ...
    {
        /// With the single argument form the result type is the same as the type of that argument, without a custom
        /// type name (e.g. `SimpleAggregateFunction(...)`) which the argument can have when it's a column of an aggregating table.
