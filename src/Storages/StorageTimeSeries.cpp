...
namespace
{
        ...
        const ASTStorage * inner_storage)
    {
        ...
        if (inner_storage)
        {
            ...
            {
                auto default_engine = getDefaultEngineForInnerTable(inner_table_kind, time_series_settings);
        ...
        {
            create->set(create->storage, getDefaultEngineForInnerTable(inner_table_kind, time_series_settings));
        }
