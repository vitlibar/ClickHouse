...
TEST(CalculateBlockNumbersForRestoring, MergeTree)
{
    ...
    auto mutations = StringPairs{
        ...
        { "0000000009.txt", "block number: 11 commands: UPDATE b = concat(b, \'F\', space(sleep(2))) WHERE 1" }, 
        { "0000000009.txt", "block number: 13 commands: UPDATE b = concat(b, \'G\', space(sleep(2))) WHERE 1" }, 
        { "0000000009.txt", "block number: 15 commands: UPDATE b = concat(b, \'H\', space(sleep(2))) WHERE 1" }, 
        { "0000000009.txt", "block number: 17 commands: UPDATE b = concat(b, \'I\', space(sleep(2))) WHERE 1" }, 
        { "0000000009.txt", "block number: 19 commands: UPDATE b = concat(b, \'J\', space(sleep(2))) WHERE 1" }, 
        { "0000000009.txt", "block number: 21 commands: UPDATE b = concat(b, \'K\', space(sleep(2))) WHERE 1" },
    };
    ...
    auto expected_result = Strings{
        ...
        "Mutation #2: 0000000009.txt -> mutation_7.txt (block number: 7 commands: UPDATE b = concat(b, \\'F\\', space(sleep(2))) WHERE 1 )",
        "Mutation #3: 0000000009.txt -> mutation_9.txt (block number: 9 commands: UPDATE b = concat(b, \\'G\\', space(sleep(2))) WHERE 1 )",
        "Mutation #4: 0000000009.txt -> mutation_11.txt (block number: 11 commands: UPDATE b = concat(b, \\'H\\', space(sleep(2))) WHERE 1 )",
        "Mutation #5: 0000000009.txt -> mutation_13.txt (block number: 13 commands: UPDATE b = concat(b, \\'I\\', space(sleep(2))) WHERE 1 )",
        "Mutation #6: 0000000009.txt -> mutation_15.txt (block number: 15 commands: UPDATE b = concat(b, \\'J\\', space(sleep(2))) WHERE 1 )",
        "Mutation #7: 0000000009.txt -> mutation_17.txt (block number: 17 commands: UPDATE b = concat(b, \\'K\\', space(sleep(2))) WHERE 1 )",
    };
    ...
    auto expected_result_2 = Strings{
        ...
        "Mutation #2: 0000000009.txt -> mutation_1806.txt (block number: 1806 commands: UPDATE b = concat(b, \\'F\\', space(sleep(2))) WHERE 1 )",
        "Mutation #3: 0000000009.txt -> mutation_1808.txt (block number: 1808 commands: UPDATE b = concat(b, \\'G\\', space(sleep(2))) WHERE 1 )",
        "Mutation #4: 0000000009.txt -> mutation_1810.txt (block number: 1810 commands: UPDATE b = concat(b, \\'H\\', space(sleep(2))) WHERE 1 )",
        "Mutation #5: 0000000009.txt -> mutation_1812.txt (block number: 1812 commands: UPDATE b = concat(b, \\'I\\', space(sleep(2))) WHERE 1 )",
        "Mutation #6: 0000000009.txt -> mutation_1814.txt (block number: 1814 commands: UPDATE b = concat(b, \\'J\\', space(sleep(2))) WHERE 1 )",
        "Mutation #7: 0000000009.txt -> mutation_1816.txt (block number: 1816 commands: UPDATE b = concat(b, \\'K\\', space(sleep(2))) WHERE 1 )",
    };
