...
public:
    ...
    static std::pair<String, std::optional<MergeTreePartition>> getPartitionIDAndValueFromQuery(const ASTPtr & ast, const ContextPtr & local_context, const StorageInMemoryMetadata & metadata, MergeTreeDataFormatVersion format_version_);
    ...
    static std::unordered_set<String> getPartitionIdsAffectedByCommands(const MutationCommands & commands, const ContextPtr & query_context, const StorageInMemoryMetadata & metadata, MergeTreeDataFormatVersion format_version_);
