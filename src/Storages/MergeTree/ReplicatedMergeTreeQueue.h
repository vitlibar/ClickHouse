...
public:
    ...
    int32_t pullLogsToQueue(const ZooKeeperWithFaultInjectionPtr & zookeeper, Coordination::WatchCallback watch_callback = {}, PullLogsReason reason = OTHER);
    ...
    void updateMutations(const ZooKeeperWithFaultInjectionPtr & zookeeper, Coordination::WatchCallbackPtr watch_callback = {});
