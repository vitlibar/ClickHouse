...
public:
    String getName() const override { return use_marks ? "Log" : "TinyLog"; }
...
private:
    ...
    std::vector<ColumnData *> files;
    size_t file_count = 0;
    std::map<String, ColumnData> files_by_stream_name;
    ...
    /// Set to false to activate the mode without using of the mark file.
