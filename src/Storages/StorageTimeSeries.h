...
/// ENGINE = TimeSeries()
/// -OR-
/// ENGINE = TimeSeries() DATA [db].table1 TAGS [db].table2 METRICS [db].table3
/// -OR-
/// ENGINE = TimeSeries() DATA ENGINE = MergeTree TAGS ENGINE = ReplacingMergeTree METRICS ENGINE = ReplacingMergeTree
/// -OR-
