...
ColumnsDescription generateTimeSeriesColumns(const TimeSeriesSettings & normalized_settings)
{
    ...
    add_column(TimeSeriesColumnNames::Type, DataTypeFactory::instance().get(makeASTDataType("String")));
    add_column(TimeSeriesColumnNames::Unit, DataTypeFactory::instance().get(makeASTDataType("String")));
