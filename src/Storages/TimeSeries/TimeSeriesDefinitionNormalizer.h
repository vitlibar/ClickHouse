...
public:
    ...
    TimeSeriesDefinitionNormalizer(const StorageID & time_series_storage_id_) : time_series_storage_id(time_series_storage_id_) {}
...
private:
    ...
    void setInnerDefaultEngine(TargetKind kind, ASTStorage & inner_storage_def, const TimeSeriesSettings & time_series_settings) const;
