...
namespace
{
    ...
    String labelMatchersToPromQL(const google::protobuf::RepeatedPtrField<prometheus::LabelMatcher> & label_matchers)
    {
        String str = "{";
        ...
        {
            const auto & tag_name = label_matcher.name();
            const auto & tag_value = label_matcher.value();
        ...
        Int64 max_time_ms)
    {
...

        {
            ...
            table_exp->table_function = makeASTFunction(
                ...
                make_intrusive<ASTLiteral>(labelMatchersToPromQL(label_matchers)),
