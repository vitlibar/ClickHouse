    ...
    ASTPtr finalizeScalarAsSQL(SQLQueryPiece && result, ConverterContext & context)
    {
        ...
        switch (result.store_method)
        {
            case StoreMethod::CONST_SCALAR:
            {
                ...
                params.select_list.push_back(timeSeriesScalarToAST(result.scalar_value, context.value_data_type));
            ...
            case StoreMethod::SCALAR_GRID:
            {
                ...
                params.select_list.push_back(makeASTCastTimeSeriesScalar(
    ...
    ASTPtr finalizeInstantVectorAsSQL(SQLQueryPiece && result, ConverterContext & context)
    {
        ...
        switch (result.store_method)
        {
            case StoreMethod::EMPTY:
            {
                ...
                ///        defaultValueOfTypeName(time_type) AS timestamp,
                ...
                params.select_list.push_back(makeASTFunction(
                    ...
                    makeASTFunction(
                        ...
                        make_intrusive<ASTLiteral>("Array(Array(Tuple(String, String)))"))));
                ...
                params.select_list.push_back(makeASTFunction("defaultValueOfTypeName", make_intrusive<ASTLiteral>("Float64")));
                params.select_list.back()->setAlias(ColumnNames::Value);
        ...
        switch (result.store_method)
        {
            case StoreMethod::EMPTY:
            {
                ...
                params.select_list.push_back(makeASTFunction(
                    ...
                    make_intrusive<ASTLiteral>(fmt::format("Array(Tuple({}, Float64))", context.timestamp_data_type->getName()))));
            ...
            case StoreMethod::CONST_SCALAR:
            {
                ...
                params.select_list.push_back(makeASTFunction(
                    ...
                    makeASTFunction(
                        ...
                        timeSeriesScalarToAST(result.scalar_value, context.value_data_type))));
            ...
            case StoreMethod::SCALAR_GRID:
            {
                ...
                params.select_list.push_back(makeASTFunction(
                    ...
                    makeASTFunction(
                        ...
                        make_intrusive<ASTLiteral>(fmt::format("Array({})", context.value_data_type->getName())))));
            ...
            case StoreMethod::VECTOR_GRID:
            {
                ...
                params.select_list.push_back(makeASTFunction(
                    ...
                    makeASTFunction(
                        "CAST",
                        make_intrusive<ASTIdentifier>(ColumnNames::Values),
                        make_intrusive<ASTLiteral>(fmt::format("Array(Nullable({}))", context.value_data_type->getName())))));
            ...
            case StoreMethod::RAW_DATA:
            {
                ...
                params.select_list.push_back(makeASTFunction(
                    ...
                    makeASTCastTimeSeriesTimestamp(make_intrusive<ASTIdentifier>(ColumnNames::Timestamp), context.timestamp_data_type),
                    makeASTCastTimeSeriesScalar(make_intrusive<ASTIdentifier>(ColumnNames::Value), context.value_data_type)));
