...
void NodeEvaluationRangeGetter::visitChildren(const Node * node, const NodeEvaluationRange & range)
{
    switch (node->node_type)
    {
        ...
        case NodeType::Subquery:
        {
            ...
            expression_range.start_time = alignTimestampDown(range.start_time - subquery_range + step, step);
            expression_range.end_time = alignTimestampDown(range.end_time, step);
