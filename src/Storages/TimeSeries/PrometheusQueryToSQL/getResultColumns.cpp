...
ColumnsDescription getResultColumns(const PQT & promql_tree, const PrometheusQueryEvaluationSettings & settings)
{
    ...
    const auto & value_data_type = settings.timestamp_data_type;
    ...
    switch (result_type)
    {
        case ResultType::SCALAR:
        {
            ...
            columns.add(ColumnDescription{ColumnNames::Value, value_data_type});
            return columns;
        }
        ...
        case ResultType::RANGE_VECTOR:
        {
            ...
            columns.add(
                ColumnDescription{
                    ...
                    std::make_shared<DataTypeArray>(std::make_shared<DataTypeTuple>(DataTypes{timestamp_data_type, value_data_type}))});
            return columns;
        }
    }
