    ...
    const Params & params)
{
    ...
    // Create PrometheusQueryEvaluationSettings structure.
    ...
    evaluation_settings.timestamp_type = timestamp_type;
    evaluation_settings.scalar_type = data_table_metadata->columns.get(TimeSeriesColumnNames::Value).type;
