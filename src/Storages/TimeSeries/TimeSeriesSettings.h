...
#define LIST_OF_TIME_SERIES_SETTINGS(M, ALIAS) \
    ...
    M(Bool, store_other_tags_as_map, true, "If set to true then all tags unspecified to the 'tags_to_column' setting will be stored in a column named 'tags'. If set to false then only tags specified in the 'tags_to_column' setting will be allowed", 0) \
