...
#define LIST_OF_TIME_SERIES_SETTINGS(M, ALIAS) \
    ...
    M(TimeSeriesIdAlgorithm, id_algorithm, TimeSeriesIdAlgorithm::SipHash128, "Algorithm used to calculate id from the metric name and tag names and values", 0) \
    M(String, id_codec, "", "Compression codec used to compress the id column in the data table", 0) \
    M(String, timestamp_type, "DateTime64(3)", "Data type of the timestamp column in the data table", 0) \
    M(String, timestamp_codec, "", "Compression codec used to compress the timestamp column in the data table", 0) \
    M(String, value_type, "Float64", "Data type of the value column in the data table", 0) \
    M(String, value_codec, "", "Compression codec used to compress the value column in the data table", 0) \
