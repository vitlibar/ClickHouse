...
///
/// Persistent insert pipelines are created in the constructor and reused across consume() calls.
...
private:
    ...
    std::unique_ptr<TargetPipeline> createTargetPipeline(ViewTarget::Kind kind, const Block & source_header);
