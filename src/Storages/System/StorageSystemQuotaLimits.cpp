...
NamesAndTypesList StorageSystemAllowedHosts::getNamesAndTypes()
{
    NamesAndTypesList names_and_types{
        {"quota", std::make_shared<DataTypeString>()},
        {"resource_type", std::make_shared<DataTypeEnum8>()},
        {"max", std::make_shared<DataTypeNullable>(std::make_shared<DataTypeFloat64>())},
        {"tracking_only", std::make_shared<DataTypeUInt8>()},
        {"time_interval", std::make_shared<DataTypeUInt64>()},
        {"randomize_time_interval", std::make_shared<DataTypeNullable>(std::make_shared<DataTypeString>())},
