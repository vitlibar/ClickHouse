                                        ...
                                        const zkutil::GetZooKeeper & get_zookeeper_function_)
{
    ...
    setEnabledNoPermissivePoliciesNoRows(config_.getBool(
        "access_compatibility_mode.no_permissive_policies_no_rows",
        true /* because we need to be compatible with earlier configurations */));
