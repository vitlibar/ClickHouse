...
public:
    ...
    static FunctionPtr create(ContextPtr) { return std::make_shared<FunctionTimeSeriesSliceSortedArray>(); }
    ...
    DataTypePtr getReturnTypeImpl(const ColumnsWithTypeAndName & arguments) const override
    {
        ...
        /// The same type as the type of the samples, without a custom type name (e.g. `SimpleAggregateFunction(...)`)
        /// which the argument can have when it's a column of an aggregating table.
