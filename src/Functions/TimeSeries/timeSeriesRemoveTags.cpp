...
class FunctionTimeSeriesRemoveTags : public IFunction, private WithContext
{
public:
    static constexpr auto name = "timeSeriesRemoveTags";

    static FunctionPtr create(ContextPtr context_) { return std::make_shared<FunctionTimeSeriesRemoveTags>(context_); }
    explicit FunctionTimeSeriesRemoveTags(ContextPtr context_) : WithContext(context_) {}
