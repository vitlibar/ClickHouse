...
class FunctionTimeSeriesReplaceTag : public IFunction, private WithContext
{
public:
    static constexpr auto name = "timeSeriesReplaceTag";

    static FunctionPtr create(ContextPtr context_) { return std::make_shared<FunctionTimeSeriesReplaceTag>(context_); }
    explicit FunctionTimeSeriesReplaceTag(ContextPtr context_) : WithContext(context_) {}
