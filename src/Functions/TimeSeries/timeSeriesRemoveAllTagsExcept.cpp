...
class FunctionTimeSeriesRemoveAllTagsExcept : public IFunction, private WithContext
{
public:
    static constexpr auto name = "timeSeriesRemoveAllTagsExcept";

    static FunctionPtr create(ContextPtr context_) { return std::make_shared<FunctionTimeSeriesRemoveAllTagsExcept>(context_); }
    explicit FunctionTimeSeriesRemoveAllTagsExcept(ContextPtr context_) : WithContext(context_) {}
