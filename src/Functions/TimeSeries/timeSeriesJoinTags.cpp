...
class FunctionTimeSeriesJoinTags : public IFunction, private WithContext
{
public:
    static constexpr auto name = "timeSeriesJoinTags";

    static FunctionPtr create(ContextPtr context_) { return std::make_shared<FunctionTimeSeriesJoinTags>(context_); }
    explicit FunctionTimeSeriesJoinTags(ContextPtr context_) : WithContext(context_) {}
