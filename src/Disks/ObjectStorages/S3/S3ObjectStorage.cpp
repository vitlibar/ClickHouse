    ...
    std::optional<ObjectAttributes> object_to_attributes)
{
    ...
    if (auto * dest_s3 = dynamic_cast<S3ObjectStorage * >(&object_storage_to); dest_s3 != nullptr)
    {
        ...
        copy_settings.scheduler = threadPoolCallbackRunner<void>(getThreadPoolWriter(), "S3ObjStor_copy");
        copy_settings.for_disk_s3 = true;
        copyS3File(client_ptr, bucket, object_from.absolute_path, dest_s3->bucket, object_to.absolute_path, copy_settings);
    }
    else
    {
    ...
    const StoredObject & object_from, const StoredObject & object_to, std::optional<ObjectAttributes> object_to_attributes)
{
    ...
    copy_settings.scheduler = threadPoolCallbackRunner<void>(getThreadPoolWriter(), "S3ObjStor_copy");
    copy_settings.for_disk_s3 = true;
    copyS3File(client_ptr, bucket, object_from.absolute_path, bucket, object_to.absolute_path, copy_settings);
}
