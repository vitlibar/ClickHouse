...
namespace
{
    ...
    {
        if (algorithm == ::clickhouse::grpc::COMPRESSION_NONE)
            return GRPC_COMPRESS_NONE;
        else if (algorithm == ::clickhouse::grpc::COMPRESSION_DEFLATE)
            return GRPC_COMPRESS_DEFLATE;
        else if (algorithm == ::clickhouse::grpc::COMPRESSION_GZIP)
            return GRPC_COMPRESS_GZIP;
        else if (algorithm == ::clickhouse::grpc::COMPRESSION_STREAM_GZIP)
            return GRPC_COMPRESS_STREAM_GZIP;
        else
    ...
    {
        if (level == ::clickhouse::grpc::COMPRESSION_LEVEL_NONE)
            return GRPC_COMPRESS_LEVEL_NONE;
        else if (level == ::clickhouse::grpc::COMPRESSION_LEVEL_LOW)
            return GRPC_COMPRESS_LEVEL_LOW;
        else if (level == ::clickhouse::grpc::COMPRESSION_LEVEL_MEDIUM)
            return GRPC_COMPRESS_LEVEL_MED;
        else if (level == ::clickhouse::grpc::COMPRESSION_LEVEL_HIGH)
            return GRPC_COMPRESS_LEVEL_HIGH;
        else
