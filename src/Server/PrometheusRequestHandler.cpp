...
void PrometheusRequestHandler::handleRemoteWriteImpl(HTTPServerRequest & request, HTTPServerResponse & response)
{
...
void PrometheusRequestHandler::handleRemoteReadImpl(HTTPServerRequest & request, HTTPServerResponse & response)
{
    ...
    auto table = DatabaseCatalog::instance().getTable(StorageID{config.remote_read->table_name}, context);
