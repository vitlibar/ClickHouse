...
public:
    ...
    void checkTableCanBeRemovedOrRenamed(const StorageID & table_id, bool check_refential_dependencies, bool check_loading_dependencies, bool is_drop_database = false) const;
...
private:
    ...
    void checkTableCanBeRemovedOrRenamedUnlocked(const StorageID & removing_table, bool check_refential_dependencies, bool check_loading_dependencies, bool is_drop_database) const TSA_REQUIRES(databases_mutex);
