...
void promqlparserParserInitialize() {
  ...
  static const int32_t serializedATNSegment[] = {
  	4,1,47,316,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,2,4,7,4,2,5,7,5,2,6,7,6,2,
  	...
  	33,1,0,0,0,202,203,3,26,13,0,203,204,5,43,0,0,204,35,1,0,0,0,205,206,
  	...
  	0,0,0,288,59,1,0,0,0,289,293,3,66,33,0,290,293,5,44,0,0,291,293,5,45,
  	...
  	305,306,5,34,0,0,306,63,1,0,0,0,307,310,5,44,0,0,308,310,3,66,33,0,309,
...
tree::TerminalNode* PromQLParser::OffsetOpContext::OFFSET_VALUE() {
  return getToken(PromQLParser::OFFSET_VALUE, 0);
}
    ...
    switch (_input->LA(1)) {
      case PromQLParser::AT: {
        ...
        case 1: {
          ...
          setState(147);
          match(PromQLParser::OFFSET_VALUE);
          break;
        }
